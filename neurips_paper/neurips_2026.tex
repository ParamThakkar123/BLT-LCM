...
% When compiling from the repository root pdflatex may not search the
% document's subdirectory for style files. Load the style via a relative
% path so it is found regardless of the current working directory.
\usepackage{neurips_paper/neurips_2026}
