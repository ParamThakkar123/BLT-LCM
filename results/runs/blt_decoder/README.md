...
* finished: 2026-08-18T06:58:14Z
* wall clock: 900.0 s
* code: `e200dba` on `main` (working tree dirty)
...
| metric | value |
| --- | --- |
| best_byte_cross_entropy | 0.5871505494020424 |
| best_epoch | 10 |
| epochs_run | 10 |
| byte_perplexity | 1.798855356201291 |
