...
* finished: 2026-08-27T02:59:37Z
* wall clock: 910.2 s
* code: `cb1e2c9` on `main` (working tree dirty)
...
| metric | value |
| --- | --- |
| best_byte_cross_entropy | 0.5825768803455391 |
| best_epoch | 10 |
| epochs_run | 10 |
| byte_perplexity | 1.7906467731019977 |
